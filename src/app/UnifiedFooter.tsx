...
export default function UnifiedFooter({ showBack = true }: { showBack?: boolean }) {
  return (
    <footer className="border-t-2 border-[#111111] pt-10 grid grid-cols-1 md:grid-cols-3 gap-8 items-center text-[10px] font-black uppercase tracking-widest w-full mt-32">
      {/* 左侧：版权 */}
      ...
      <div className="flex justify-center md:justify-end">
        {showBack && (
          <Link href="/" className="hover:text-[#ff751f] transition-colors underline flex items-center gap-2">
            <Icons.ArrowLeft /> BACK TO TERMINAL
          </Link>
        )}
      </div>
    </footer>
